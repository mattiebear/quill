...
import {
	ArrowsPointingOutIcon as ArrowsPointingOutIconBase,
...
export const ArrowsPointingOutIcon = chakra(ArrowsPointingOutIconBase);
...
export const PaintBrushIcon = chakra(PaintBrushIconBase);
